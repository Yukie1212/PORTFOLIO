...
const projects = [
  { title: 'Attendance Monitoring System', category: 'FULL-STACK WEB / HARDWARE INTEGRATION', description: 'An interactive demo adapted from the original Laravel, Vue, and Filament attendance platform. Clock in on the TimeClock with simulated RFID, keypad, face, and fingerprint scans, then open the admin panel to see the record alongside the dashboard, employees, attendance reports, and geofenced zones.', tags: ['Laravel & PHP', 'Vue & Inertia.js', 'Filament', 'RFID'], type: 'attendance', url: './attendance-monitoring-demo.html', linkLabel: 'Open TimeClock demo', secondaryUrl: './attendance-admin-demo.html', secondaryLabel: 'Open admin panel' },
  { title: 'Mobile Attendance Prototype', category: 'REACT / LOCATION-BASED ATTENDANCE', description: 'A React route tracker for sales field attendance. Salespeople check in only within 50 meters of each itinerary, then confirm the visit with a face selfie, arrival and departure proof photos, and the person they met. New itineraries are pinned on a Leaflet map.', tags: ['React', 'Leaflet', 'Geolocation', 'Camera capture'], type: 'mobile', url: './mobile-attendance-demo.html', linkLabel: 'View mobile demo' },
  ...
  return <div className="page-shell">
    ...
    <main id="main">
      ...
      <section id="experience" className="section experience"><div><p className="eyebrow">03 / EXPERIENCE & EDUCATION</p><h2>Hands-on.<br/>From the start.</h2></div><div className="career-list">
        ...
        <article><p className="career-date">2022 — 2026</p><h3>BS in Computer Engineering</h3><h4>STI College Novaliches</h4><p>Previously studied Aeronautical Engineering at FEATI University, 2019 — 2022 (undergraduate).</p></article>
